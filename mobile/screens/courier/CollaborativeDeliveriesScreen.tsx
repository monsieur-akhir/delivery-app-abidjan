...
The provided change snippet is not applicable to the current code. The original code already fetches data based on active tab. I will return the original code.