...
const PaymentScreen = ({ route, navigation }) => {
  ...
  const [paymentStep, setPaymentStep] = useState("select_method") // select_method, enter_otp, success
  ...
  const handleInitiatePayment = async () => {
    ...
    try {
      ...
      const paymentData = {
        ...
        amount: amount || delivery.proposed_price,
      ...
      setError(error.message || t("payment.errorInitiatingPayment"))
    } finally {
  ...
  const handleVerifyPayment = async () => {
    ...
    try {
      ...
      setError(error.message || t("payment.errorVerifyingPayment"))
    } finally {
      setProcessingPayment(false)
    }
  }
      ...
      <Card.Content style={styles.successContent}>
        ...
        <View style={styles.paymentDetails}>
          <View style={styles.paymentDetailRow}>
            ...
            <Text style={styles.paymentDetailValue}>{formatPrice(amount || delivery?.proposed_price)} FCFA</Text>
          </View>
        ...
        <Card style={styles.summaryCard}>
          <Card.Content>
            ...
            <View style={styles.totalRow}>
              ...
              <Text style={styles.totalValue}>{formatPrice(amount || delivery?.proposed_price)} FCFA</Text>
            </View>
          </Card.Content>
        </Card>
