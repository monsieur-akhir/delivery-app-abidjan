...
class BusinessProfile(Base):
    ...
    # Nouvelles relations pour les véhicules et règles de transport
    vehicles = relationship("Vehicle", back_populates="business")
    transport_rules = relationship("TransportRule", back_populates="business")
...
class CourierProfile(Base):
    ...
    # Nouvelle relation pour les véhicules
    vehicles = relationship("CourierVehicle", back_populates="courier")
