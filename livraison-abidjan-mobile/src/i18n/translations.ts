...
estimatedEarnings: "Gains estimés",
          ...
          acceptedSuccess: 'Livraison acceptée avec succès',
          proposedPrice: 'Prix proposé',
          estimatedTime: 'Temps estimé',
          distance: 'Distance',
          packageType: 'Type de colis',
          description: 'Description',
          specialInstructions: 'Instructions spéciales',
          ignoreTitle: 'Ignorer cette livraison',
          ignoreConfirmation: 'Êtes-vous sûr de vouloir ignorer cette livraison ?',
          ignored: 'Livraison ignorée',
          ignoredMessage: 'Cette livraison n\'apparaîtra plus dans votre liste',
          counterOfferTitle: 'Faire une contre-offre',
          counterOfferPrompt: 'Prix original: {{originalPrice}} FCFA. Entrez votre prix:',
          sendOffer: 'Envoyer',
          counterOfferSent: 'Contre-offre envoyée',
          counterOfferSentMessage: 'Votre contre-offre a été envoyée au client',
          counterOfferMessage: 'Je peux faire cette livraison pour ce prix',
        },
        profile: {
