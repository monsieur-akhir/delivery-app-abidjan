<template>
  <div class="add-funds-form">
    <div class="form-group">
      <label for="funds-amount" class="form-label">Montant (FCFA) <span class="required">*</span></label>
      <input 
        type="number" 
        id="funds-amount" 
    ...
    <div class="form-group">
      <label for="funds-source" class="form-label">Source des fonds <span class="required">*</span></label>
    ...
    <div class="form-group" v-if="source === 'other'">
      <label for="custom-source" class="form-label">Source personnalisée <span class="required">*</span></label>
      <input 
        type="text" 
        id="custom-source" 
