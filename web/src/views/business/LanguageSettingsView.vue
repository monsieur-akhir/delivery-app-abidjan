    ...
    <div v-else class="settings-content">
      ...
      <div class="settings-card">
        ...
        <div class="card-body">
          ...
          <div class="form-group checkbox-group">
            <input type="checkbox" id="auto-translate" v-model="languageSettings.auto_translate" />
            <label for="auto-translate"
              >Traduire automatiquement les messages dans la langue du client</label
            >
          </div>
        </div>
      </div>
      ...
      <div class="settings-card">
        <div class="card-header">
          ...
          <p class="help-text">
            Sélectionnez les langues supplémentaires que vous souhaitez prendre en charge.
          </p>
        </div>
        <div class="card-body">
      ...
      <div class="settings-card">
        <div class="card-header">
          ...
          <p class="help-text">
            Personnalisez les traductions pour les termes spécifiques à votre entreprise.
          </p>
        </div>
        <div class="card-body">
          <div class="custom-translations">
            ...
            >
              <div class="translation-key">
                <input type="text" v-model="translation.key" placeholder="Terme" />
              </div>
              <div
                v-for="language in activeLanguages"
              ...
              <div class="translation-actions">
                <button type="button" class="btn-icon btn-danger" @click="removeTranslation(index)">
      ...
      <div class="settings-card">
        ...
        <div class="card-body">
          <div class="form-group checkbox-group">
            ...
            />
            <label for="multilingual-notifications"
              >Envoyer les notifications dans la langue préférée du client</label
            >
          </div>
          <div class="form-group checkbox-group">
            <input
            ...
            />
            <label for="multilingual-invoices"
              >Générer les factures dans la langue préférée du client</label
            >
          </div>
          <div class="form-group checkbox-group">
            <input
          ...
          <div class="form-group">
            ...
            <p class="input-help">
              Langue utilisée lorsque la traduction n'est pas disponible dans la langue préférée du
              client.
            </p>
          </div>
        </div>
      ...
      <div class="settings-card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <p class="input-help">
              Maintenez la touche Ctrl (ou Cmd sur Mac) pour sélectionner plusieurs langues.
            </p>
          </div>
          <div class="form-group">
  ...
  setup() {
    ...
    const activeLanguages = computed(() => {
      return availableLanguages.filter(lang =>
        languageSettings.active_languages.includes(lang.code)
      )
    })
    ...
    const saveSettings = async () => {
      ...
      try {
        ...
        showToast(
          'Erreur',
          "Impossible d'enregistrer les paramètres linguistiques. Veuillez réessayer.",
          'error'
        )
      } finally {
    ...
    const toggleLanguage = code => {
      ...
      if (isLanguageActive(code)) {
        // Retirer la langue
        languageSettings.active_languages = languageSettings.active_languages.filter(
          lang => lang !== code
        )

        // Retirer également de la liste des langues vocales si nécessaire
        if (languageSettings.voice_languages.includes(code)) {
          languageSettings.voice_languages = languageSettings.voice_languages.filter(
            lang => lang !== code
          )
        }
