      ...
      <div class="settings-panel">
        ...
        <div v-if="activeTab === 'general'" class="settings-section">
          ...
          <div class="form-group">
            ...
            <input
              type="text"
              id="business_name"
              v-model="settings.general.business_name"
              class="form-control"
            />
          </div>
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              v-model="settings.general.business_description"
              class="form-control"
              rows="3"
            ></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <select
              id="business_commune"
              v-model="settings.general.business_commune"
              class="form-control"
            >
          ...
          <div class="form-group">
            ...
            <input
              type="tel"
              id="business_phone"
              v-model="settings.general.business_phone"
              class="form-control"
            />
          </div>
          ...
          <div class="form-group">
            ...
            <input
              type="email"
              id="business_email"
              v-model="settings.general.business_email"
              class="form-control"
            />
          </div>
          ...
          <div class="form-group">
            ...
            <input
              type="url"
              id="business_website"
              v-model="settings.general.business_website"
              class="form-control"
            />
          </div>
          ...
          <div class="form-group">
            ...
            <div class="business-hours">
              <div v-for="(day, index) in businessHours" :key="day.day" class="business-day">
                ...
                <div class="day-closed" v-else>Fermé</div>
              </div>
            </div>
          </div>
        ...
        <div v-if="activeTab === 'delivery'" class="settings-section">
          ...
          <div class="form-group">
            ...
            <input
              type="number"
              id="default_price"
              v-model="settings.delivery.default_price"
              class="form-control"
              min="0"
            />
          ...
          <div class="form-group">
            ...
            <input
              type="number"
              id="min_price"
              v-model="settings.delivery.min_price"
              class="form-control"
              min="0"
            />
          ...
          <div class="form-group">
            ...
            <input
              type="number"
              id="max_distance"
              v-model="settings.delivery.max_distance"
              class="form-control"
              min="0"
            />
            ...
            <div class="communes-grid">
              <div v-for="commune in communes" :key="commune" class="commune-checkbox">
                <input
                  type="checkbox"
                  :id="`commune_${commune}`"
                  v-model="settings.delivery.service_areas"
                  :value="commune"
                />
            ...
            <div class="package-types">
              <div v-for="(type, key) in packageTypes" :key="key" class="package-type-checkbox">
                <input
                  type="checkbox"
                  :id="`package_${key}`"
                  v-model="settings.delivery.accepted_package_types"
                  :value="key"
                />
          ...
          <div class="form-group">
            ...
            <div class="toggle-switch">
              <input
                type="checkbox"
                id="auto_accept_bids"
                v-model="settings.delivery.auto_accept_bids"
              />
          ...
          <div class="form-group" v-if="settings.delivery.auto_accept_bids">
            ...
            <input
              type="number"
              id="auto_accept_delay"
              v-model="settings.delivery.auto_accept_delay"
              class="form-control"
              min="1"
            />
          </div>
          ...
          <div class="form-group">
            ...
            <div class="toggle-switch">
              <input
                type="checkbox"
                id="allow_express_delivery"
                v-model="settings.delivery.allow_express_delivery"
              />
          ...
          <div class="form-group" v-if="settings.delivery.allow_express_delivery">
            <label for="express_price_multiplier"
              >Multiplicateur de prix pour livraison express</label
            >
            <input
              type="number"
              id="express_price_multiplier"
              v-model="settings.delivery.express_price_multiplier"
              class="form-control"
              min="1"
              step="0.1"
            />
        ...
        <div v-if="activeTab === 'payment'" class="settings-section">
            ...
            <div class="payment-methods">
              ...
              >
                <input
                  type="checkbox"
                  :id="`payment_${key}`"
                  v-model="settings.payment.accepted_methods"
                  :value="key"
                />
          ...
          <div v-if="settings.payment.accepted_methods.includes('orange_money')" class="form-group">
            ...
            <input
              type="tel"
              id="orange_money_number"
              v-model="settings.payment.orange_money_number"
              class="form-control"
            />
          </div>
          ...
          <div v-if="settings.payment.accepted_methods.includes('mtn_money')" class="form-group">
            ...
            <input
              type="tel"
              id="mtn_money_number"
              v-model="settings.payment.mtn_money_number"
              class="form-control"
            />
          </div>

          <div
            v-if="settings.payment.accepted_methods.includes('bank_transfer')"
            class="form-group"
          >
            ...
            <input
              ...
              v-model="settings.payment.bank_account_name"
              class="form-control"
            />
          </div>
          ...
          >
            ...
            <input
              ...
              v-model="settings.payment.bank_account_number"
              class="form-control"
            />
          </div>
          ...
          <div class="form-group">
            ...
            <div class="toggle-switch">
              <input
                ...
                v-model="settings.payment.auto_generate_invoice"
              />
          ...
          <div class="form-group">
            ...
            <input
              type="text"
              id="invoice_prefix"
              v-model="settings.payment.invoice_prefix"
              class="form-control"
            />
          ...
          <div class="form-group">
            ...
            <textarea
              id="invoice_footer"
              v-model="settings.payment.invoice_footer"
              class="form-control"
              rows="3"
            ></textarea>
        ...
        <div v-if="activeTab === 'notification'" class="settings-section">
          ...
          <div class="form-group">
            ...
            <div class="notification-channels">
              <div
                ...
                :key="key"
                class="notification-channel-checkbox"
              >
                <input
                  type="checkbox"
                  :id="`channel_${key}`"
                  v-model="settings.notification.channels"
                  :value="key"
                />
          ...
          <div class="form-group">
            ...
            <div class="notification-events">
              <div
                v-for="(event, key) in notificationEvents"
                :key="key"
                class="notification-event-checkbox"
              >
                <input
                  type="checkbox"
                  :id="`event_${key}`"
                  v-model="settings.notification.events"
                  :value="key"
                />
          ...
          <div class="form-group">
            ...
            <div class="toggle-switch">
              <input
                ...
                v-model="settings.notification.sound_enabled"
              />
          ...
          <div class="form-group">
            ...
            <div class="toggle-switch">
              <input
                ...
                v-model="settings.notification.desktop_enabled"
              />
              <label for="notification_desktop"></label>
            </div>
            <p class="form-help">
              Afficher les notifications même lorsque le navigateur est en arrière-plan
            </p>
          </div>
        ...
        <div v-if="activeTab === 'appearance'" class="settings-section">
          ...
          <div class="form-group">
            ...
            <select
              id="items_per_page"
              v-model="settings.appearance.items_per_page"
              class="form-control"
            >
        ...
        <div v-if="activeTab === 'security'" class="settings-section">
          ...
          <div class="form-group">
            ...
            <div class="toggle-switch">
              <input
                type="checkbox"
                id="ip_restriction"
                v-model="settings.security.ip_restriction"
              />
          ...
          <div class="form-group" v-if="settings.security.ip_restriction">
            ...
            <textarea
              id="allowed_ips"
              v-model="settings.security.allowed_ips"
              class="form-control"
              rows="3"
...
export default {
  ...
  setup() {
    ...
    const passwordStrength = computed(() => {
      ...
      if (/[a-z]/.test(passwordForm.new_password) && /[A-Z]/.test(passwordForm.new_password))
        score++
